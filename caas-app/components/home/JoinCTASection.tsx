  ...
  return (
    <Section className="relative overflow-hidden bg-primary py-32">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        {/* Body */}
        <p
          className="mx-auto mt-5 max-w-xl text-lg text-primary-foreground/75 text-balance"
          style={{ animation: "ctaFadeUp 0.6s ease 0.2s both" }}
        >
          Whether you're an organization looking to grow your community or
          someone searching for the next great experience — JoinYourEvent.com is
          where it all happens. Post events, build audiences, and connect with
        ...
        {/* <p
          ...
          style={{ animation: "ctaFadeUp 0.6s ease 0.4s both" }}
        >
          🌍 Join{" "}

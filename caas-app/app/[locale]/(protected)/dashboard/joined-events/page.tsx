...
import JoinedEventsOverview from "@/components/events/JoinedEvents";
...
export async function getEvents() {
  const res = await serverFetch("/event/events/joined-events/");
  return res;
}

export default async function DashboardPage() {
  await requirePermission("events-joined-events:get");

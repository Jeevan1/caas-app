...
export const metadata = {
  ...
  description: "Learn how CaaS helps you promote, grow, and track your business in three simple steps.",
}
...
const campaignTypes = [
  {
    ...
    description: "Promote workshops, concerts, meetups, and conferences with targeted campaigns.",
  },
  {
    icon: Target,
    title: "Product Launch",
    description: "Build hype and drive sales for new product releases with multi-channel marketing.",
  },
  {
    icon: Mail,
    title: "Email Campaigns",
    description: "Reach your audience directly with beautifully designed email marketing templates.",
  },
  {
    icon: Share2,
    title: "Social Media Blitz",
    description: "Create engaging social media content across all platforms simultaneously.",
  },
  {
    icon: FileImage,
    title: "Print Materials",
    description: "Design and download professional flyers, posters, and brochures.",
  },
  {
    icon: TrendingUp,
    title: "Referral Programs",
    description: "Grow organically with automated referral link campaigns and tracking.",
  },
]
            ...
            <div className="flex flex-col gap-16">
              {detailedSteps.map((item, index) => (
                ...
                >
                  ...
                  {/* Visual Card */}
                  <div className={`rounded-2xl border border-border bg-background p-8 ${index % 2 !== 0 ? "lg:[direction:ltr]" : ""}`}>
                    <div className="flex flex-col items-center justify-center gap-4 py-8">
                      <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-primary/10">
                        <item.icon className="h-10 w-10 text-primary" />
                      </div>
                      <p className="text-center text-lg font-semibold text-foreground">{item.title}</p>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {campaignTypes.map((ct) => (
                ...
                >
                  ...
                  <h3 className="mb-2 text-lg font-semibold text-foreground">{ct.title}</h3>
                  <p className="text-sm leading-relaxed text-muted-foreground">{ct.description}</p>
                </div>
              ))}
            </div>

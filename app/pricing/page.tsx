...
export const metadata = {
  title: "Pricing - CaaS",
  description: "Choose the perfect plan for your business. Start free or upgrade for unlimited campaigns and premium features.",
}
...
const plans = [
  ...
  },
  {
    ...
    price: "$19",
    period: "/month",
    description: "Unlimited campaigns and advanced features for growing businesses.",
    cta: "Start Pro Trial",
    highlighted: true,
    features: [
  ...
  },
  {
    ...
    price: "$49",
    period: "/month",
    description: "Full platform access with API, dedicated support, and custom integrations.",
    cta: "Contact Sales",
    highlighted: false,
    features: [
